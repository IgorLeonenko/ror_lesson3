...
User.create(name: 'Igor', email: 'igrleon@gmail.com', password: '123456')
User.create(name: 'Ivan', email: 'ivan@email.ww', password: '654321')
...
Post.create(user_id: 1, title: 'Test1', body: body, tags: '')
Post.create(user_id: 1, title: 'Test2', body: body1, tags: '')
Post.create(user_id: 1, title: 'Test3', body: body2, tags: '')
Post.create(user_id: 1, title: 'Test4', body: body2, tags: '')
Post.create(user_id: 1, title: 'Test5', body: body1, tags: '')
Post.create(user_id: 1, title: 'Test6', body: body, tags: '')
Post.create(user_id: 1, title: 'Test7', body: body2, tags: '')
Post.create(user_id: 1, title: 'Test8', body: body1, tags: '')
Post.create(user_id: 1, title: 'Test9', body: body1, tags: '')
Post.create(user_id: 2, title: 'Test10', body: body, tags: '')
Post.create(user_id: 2, title: 'Test11', body: body1, tags: '')
Post.create(user_id: 2, title: 'Test12', body: body2, tags: '')
Post.create(user_id: 2, title: 'Test13', body: body2, tags: '')
Post.create(user_id: 2, title: 'Test14', body: body1, tags: '')
Post.create(user_id: 2, title: 'Test15', body: body, tags: '')
Post.create(user_id: 2, title: 'Test16', body: body2, tags: '')
Post.create(user_id: 2, title: 'Test17', body: body1, tags: '')
Post.create(user_id: 2, title: 'Test18', body: body1, tags: '')